...
- [ ] At least one task was kept smaller because of `task-chunking`.
- [ ] At least one round ended with a clearer stop-or-continue decision because of `checkpoint-review`.
- [ ] At least one handoff or restart became easier because of `handoff-summary`.
