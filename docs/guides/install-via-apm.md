...
36 portable skills, one per directory, each with a `SKILL.md` entrypoint.
...
|---|---|
| `skills/**` (all 36 portable skills) | `domain-packs/` (see below) |
...
All 36 skills should report conformant.
...
- [ADR-004 — agentskills.io conformance strategy](https://nevitonsantana.github.io/adaptive-skills/adr/ADR-004-agentskills-io-conformance/)
- [ADR-005 — APM packaging strategy](https://nevitonsantana.github.io/adaptive-skills/adr/ADR-005-apm-packaging-strategy/)
- [`docs/skill-categories.md`](https://nevitonsantana.github.io/adaptive-skills/skill-categories/) — category taxonomy and per-category backlog
- [`docs/how-to-use-a-skill.md`](https://nevitonsantana.github.io/adaptive-skills/how-to-use-a-skill/) — invocation patterns once skills are installed
