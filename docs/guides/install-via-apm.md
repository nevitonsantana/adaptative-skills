...
35 portable skills, one per directory, each with a `SKILL.md` entrypoint.
...
|---|---|
| `skills/**` (all 35 portable skills) | `domain-packs/` (see below) |
...
All 35 skills should report conformant.
