...
This installs all **36 canonical portable skills**. Domain packs, repository governance records, capability metadata, and evolution artifacts are not part of the standard capability payload.
