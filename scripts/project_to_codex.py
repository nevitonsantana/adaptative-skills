...
def project_skill(skill: dict, codex_root: Path, dry_run: bool, check: bool):
    ...
    if check:
        for label, target, expected in [('SKILL', target_skill, expected_skill), ('openai.yaml', target_yaml, expected_yaml)]:
